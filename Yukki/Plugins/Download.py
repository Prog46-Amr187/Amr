...
**ملحوظه:**
هذه الاوامر للمطورين فقط

/gban [اسم المستخدم أو الرد على مستخدم]
- حظر مستخدم عالميًا في الدردشات التي يقدمها برنامج Bot ويمنع المستخدم من استخدام أوامر bot

/ungban [اسم المستخدم أو الرد على مستخدم]
- إزالة مستخدم من قائمة GBan الخاصة بالبوت.‌‌
"""
...
def inl_mark(videoid, user_id):
    buttons = [
        ...
        [
            InlineKeyboardButton(
                text="⬅️  رجوع للخلف", callback_data=f"good {videoid}|{user_id}"
            ),
            InlineKeyboardButton(
...
👀**المشاهدات:** `{views}`
🎥**القناه Name:** {channel}
🔗**رابط الفديو:** [Link]({yturl})

⚡️ تم البحث والتحميل بواسطه {MUSIC_BOT_NAME}"""
