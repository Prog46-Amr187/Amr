...
• اختصاصي تشغيل الموسيقى في الدردشات الصوتيه مع بعض المميزات المفيده

• يمكنك استخدام جميع الاوامر مع: / """
                ...
                [
                    [
                        InlineKeyboardButton(
                            text="🎥 مشاهده علي اليوتيوب", url=f"{link}"
                        ),
                        InlineKeyboardButton(
...
async def help_parser(name, keyboard=None):
    ...
    return (
        """مرحبا عزيزي {first_name},

هنا الازرار الخاصه بكل امر بالاسفل ومع كل زر الشرح الخاص به.
...
async def help_button(client, query):
    ...
    top_text = f"""مرحبا بك {query.from_user.first_name},
